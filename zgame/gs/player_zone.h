#ifndef __ONLINEGAME_GS_PLAYER_ZONE_H__
#define __ONLINEGAME_GS_PLAYER_ZONE_H__

#include "player_imp.h"

//¿ç·þÍæ¼Ò
class gplayer_zone_imp : public gplayer_imp
{
private:
...
public:
	DECLARE_SUBSTANCE(gplayer_zone_imp);
