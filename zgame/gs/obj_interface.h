...
public:
	...
	void Heal(const XID & healer,size_t life, bool can_heal_blood_pool);
	void Heal(size_t life, bool is_potion, bool can_heal_bloodpool);
...
public:
	...
	void RegionEnchant1(A3DVECTOR const& pos, float radius, enchant_msg& msg, size_t mc, std::vector<exclude_target, std::allocator<exclude_target> >& target_exclude);
	void RegionEnchant2(A3DVECTOR const& pos, float radius, enchant_msg& msg, size_t mc, std::vector<exclude_target, std::allocator<exclude_target> >& target_exclude);
	void RegionEnchant3(A3DVECTOR const& pos, float cos_half_angle, enchant_msg& msg, size_t mc, std::vector<exclude_target, std::allocator<exclude_target> >& target_exclude);
...
public:
	...
	bool CreatePet(const A3DVECTOR& pos,const pet_data* pData,const pet_bedge_essence* pEss,int tid,size_t pet_index,XID& who, int reborn_cnt, void * cd_buf, size_t cd_len);
