...
-------------------------------------------------------------------------------------------------
--	·¨±¦¹àÄ§º¯ÊıËµÃ÷
--	EnchantTalismans( id, talisman, cid, output )
--	id ÎªĞèÒª¹àÄ§µÄ·¨±¦id
--	talismanÎªĞèÒª¹àÄ§µÄ·¨±¦µÄ¶ÔÏó Õâ¸ö¶ÔÏóÍ¬init reset levelupÈı¸öµ÷ÓÃ´«ÈëµÄtalisman
--	cid Îª¹àÄ§Ê±Ê¹ÓÃµÄÁéÃ½id
--	output Îª²ú³ö¿ØÖÆ¶ÔÏó£¬ ´Ë¶ÔÏó¿ÉÒÔµ÷ÓÃCreateItem½Ó¿Ú
--	output²ú³ö¿ØÖÆ¶ÔÏó½Ó¿ÚÍ¬ÈÚºÏ
...
function EnchantTalismans( id1, talisman1, cid, output )
	-- ÕâÀïÊÇÔÚÃ»Ğ´¶«Î÷Ö®¼ä²âÊÔÓÃµÄ£¬²»Æğ×÷ÓÃ
	if(cid ~= 0) then
		output:CreateItem(4685);		--Èç¹ûÓĞÁéÃ½£¬±ä¸ö¶«Î÷³öÀ´¿´¿´
		output:UpdateData(4, 1);
		test_init(4685, output);
	else
		output:CreateItem(-1);			--Ã»ÓĞÁéÃ½,Ê²Ã´¶¼²»Éú³É
	end
end
